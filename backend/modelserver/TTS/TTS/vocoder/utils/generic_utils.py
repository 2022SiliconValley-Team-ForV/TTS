...
def setup_generator(c):
    ...
    MyModel = importlib.import_module("TTS.TTS.vocoder.models." + c.generator_model.lower())
...
def setup_discriminator(c):
    ...
    if "parallel_wavegan" in c.discriminator_model:
        MyModel = importlib.import_module("TTS.TTS.vocoder.models.parallel_wavegan_discriminator")
    else:
        MyModel = importlib.import_module("TTS.TTS.vocoder.models." + c.discriminator_model.lower())
