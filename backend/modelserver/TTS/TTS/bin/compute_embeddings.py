...
from TTS.TTS.tts.utils.speakers import save_speaker_mapping
...
parser.add_argument(
    ...
    type=str,
    default="",
    help="Target dataset to pick a processor from TTS.TTS.tts.dataset.preprocess. Necessary to create a speakers.json file.",
)
