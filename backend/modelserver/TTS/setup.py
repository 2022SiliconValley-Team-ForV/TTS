...
from TTS.TTS._version import __version__
...
exts = [Extension(name='TTS.TTS.tts.layers.glow_tts.monotonic_align.core',
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'tts=TTS.TTS.bin.synthesize:main',
            'tts-server = TTS.TTS.server.server:main'
        ]
    },
    classifiers=[
